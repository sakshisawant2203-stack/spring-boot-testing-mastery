...
public class JournalEntryControllerLink {
    ...
    @GetMapping
    public ResponseEntity<?> getAllJornalEntriesofUsers() {
    ...
    public ResponseEntity<JournalEntry> createEntry(@RequestBody JournalEntry myEntry) {
        try {
            Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
            // created the authentication object
            // now passing the ser and entry to save in journalEntry sevices
            String username = authentication.getName(); // extracted the username from authentication object
    ...
    public ResponseEntity<?> getJournalEntryById(@PathVariable ObjectId myId) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String username = authentication.getName();
        User user = userService.findByUserName(username); // we check the myId by this username
